...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
            ...
            '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="/qiniu/uploadImage.do">',
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
            '<input type="hidden"  name="token" class="qiniu_token" value=""/>',
			...
			yesBtn : {
				...
				click : function(e) {
					...
					if (showLocal && showRemote && tabs && tabs.selectedIndex === 1 || !showRemote) {
						...
						dialog.showLoading(self.lang('uploadLoading'));
						//设置七牛token
                        $("input.qiniu_token").val($("#qiniuToken").val());
						uploadbutton.submit();
						localUrlBox.val('');
						return;
					}
