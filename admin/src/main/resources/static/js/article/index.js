layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function(){
  ...
  table.render({
    ...
    ,cols: [[
      {field:'id',   title: 'ID'},
  {field:'userName',   title: '用户名'},{field:'title',   title: '标题'},{field:'content',   title: '内容'},{field:'labelName',   title: '标签名字'},{field:'remark',   title: '备注'},
   ...
   table.on('tool(table)', function(obj){
     ...
     if(layEvent === 'detail'){
       ...
       layer.confirm('确定删除？', function(index){
        ...
        location.href="/page/article/edit?id="+data.id;
     }
   });
});