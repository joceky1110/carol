...
$('#searchForm .layui-btn').on('click', function(){
 ...
 //监听工具条
   table.on('tool(table)', function(obj){
     ...
     if(layEvent === 'detail'){
       location.href="/page/userInfo/info?id="+data.id;
     } else if(layEvent === 'del'){
       layer.confirm('确定删除？', function(index){
            layer.close(index);
            $.ajax({
                url:'/data/userInfo/delete',
                data:{id:data.id},
                method:"post",
                dataType:"json",
        ...
        location.href="/page/userInfo/edit?id="+data.id;
     }
   });
});