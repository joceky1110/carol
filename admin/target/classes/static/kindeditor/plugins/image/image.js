...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + '/upload_json.do'),
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
			'<input type="text"  name="token" class="qiniu_token" />',
        ...
        success: function (data) {
            if (data) {
                setTimeout(function a() {
                    alert($("input.qiniu_token").val());
                    $("input.qiniu_token").attr("value",data);
                    alert("2" + $("input.qiniu_token").attr("value"));
				},5000)
