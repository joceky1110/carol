...
public class ReadRecord extends BaseEntity {
     ...
     * 书名
     */
   	@Column(name="BOOK_NAME",columnDefinition="varchar(100) COMMENT '书名'")
     ...
     * 图片
     */
   	@Column(name="IMG",columnDefinition="varchar(500) COMMENT '图片'")
   	private String img;
     ...
     * 分享
     */
   	@Column(name="SHARE",columnDefinition="int COMMENT '分享'")
